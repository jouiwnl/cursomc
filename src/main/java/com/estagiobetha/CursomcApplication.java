...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli2 = new Cliente(null, "Michel", "michel@gmail.com", "56415845589", TipoCliente.PESSOAFISICA);
		Cliente cli3 = new Cliente(null, "Rodrigo", "Rodrigo@gmail.com", "9878979878", TipoCliente.PESSOAJURIDICA);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323","938993893"));
		cli2.getTelefones().addAll(Arrays.asList("559626526","93993893"));
		cli3.getTelefones().addAll(Arrays.asList("6513512531","93223893"));
